...
class StockClass:
    ...
    def getData(self, i_symbol, i_destDictKey, i_freq='d'):
        ...
        self.m_data[i_destDictKey]['data']['d'] = self.m_data[i_destDictKey]['data']['d'].fillna(0)
        self.m_data[i_destDictKey]['data']['w'] = self.m_data[i_destDictKey]['data']['w'].fillna(0)
        self.m_data[i_destDictKey]['data']['m'] = self.m_data[i_destDictKey]['data']['m'].fillna(0)
